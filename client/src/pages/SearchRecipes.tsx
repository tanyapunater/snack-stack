...
const getRecipes = (): Recipe[] => [
  {
    ...
    imageUrl:
      "https://bakeitwithlove.com/wp-content/uploads/2022/01/Spaghetti-Bolognese-sq.jpg",
    category: "Italian",
  },
  {
    id: 2,
    title: "Chicken Curry",
    description:
      "A spicy and flavorful chicken dish cooked in a rich curry sauce.",
    ingredients: ["chicken", "curry powder", "coconut milk", "onion", "garlic"],
    instructions: "In a pan, cook chopped onion and garlic until softened...",
    imageUrl:
      "https://th.bing.com/th/id/OIP.N_lyNbhtJvQbYPPup_CMlwHaHa?rs=1&pid=ImgDetMain",
    category: "Indian",
  },
  {
    id: 3,
    ...
    imageUrl:
      "https://cdn.apartmenttherapy.info/image/upload/f_auto,q_auto:eco,c_fill,g_auto,w_1500/k/Photo/Recipes/2019-10-recipe-brussels-sprouts-caesar-salad/BrusselsSproutCaesarSaladOption1",
    category: "Salad",
  },
  {
    id: 4,
    ...
    imageUrl:
      "https://davidscookies.com/cdn/shop/files/cGGK3qk8.jpg?v=1738691344&width=493",
    category: "Dessert",
  },
  {
    id: 5,
    title: "Tacos",
    description:
      "Soft or hard shell tacos filled with seasoned meat and toppings.",
